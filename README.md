...
Or you can use [the demo](https://kokes.github.io/nbviewer.js/viewer.html) (or a local copy), which is just a simple wrapper of the library, with dropzones and other basic features. A rendered notebook can be downloaded as HTML or PDF directly in the browser. There is no data being transferred anywhere, so feel free to bookmark it and use it.
